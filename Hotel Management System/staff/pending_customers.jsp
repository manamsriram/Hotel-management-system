...
<html lang="en" class="no-js">
	...
	<body>  
        ...
        try{
            sql = "SELECT COUNT(id) count FROM customer where room_number is NULL;";
        ...
        int i=0;
            ...
            try
            {
                sql1 = "select * from customer where room_number is NULL;";
        ...
        <div class="desc">
            ...
            <form action="assign_room.jsp" class="myform" method="post">
